...
if __name__ == '__main__':
    a = DBCondition(EmbeddingModels.id, sql_operator.SqlOperator.EQL, "12")
    a.build_condition()
    b = DBCondition(EmbeddingModels.title, sql_operator.SqlOperator.EQL, "15")
    b.build_condition()
    d = DBCondition(EmbeddingModels.embedding, sql_operator.SqlOperator.GTE, "17")
    d.build_condition()
    c = a & ((b | d) & (b | a))
    print(c.condition)
